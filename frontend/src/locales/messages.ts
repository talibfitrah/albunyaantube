    ...
    contentSearch: {
      ...
      bulk: {
        ...
        input: {
          ...
          defaultCategoriesLabel: 'Default categories (required)',
    ...
    contentSearch: {
      ...
      bulk: {
        ...
        input: {
          ...
          defaultCategoriesLabel: 'الفئات الافتراضية (مطلوبة)',
    ...
    contentSearch: {
      ...
      bulk: {
        ...
        input: {
          ...
          defaultCategoriesLabel: 'Standaardcategorieën (verplicht)',
