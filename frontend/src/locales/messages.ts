export const messages = {
  en: {
    ...
    contentSearch: {
      ...
      searchPlaceholder: 'Search for channels, playlists, or videos, or paste a YouTube URL...',
      search: 'Search',
      searching: 'Searching...',
      urlDetected: 'YouTube {type} URL detected — will look up directly',
      urlNotFound: 'This content is unavailable, private, or does not exist.',
      retry: 'Retry',
      ...
      bulk: {
        ...
        loading: 'Working…',
        input: {
          pasteLabel: 'Paste YouTube URLs (one per line)',
          pasteHint: 'https://www.youtube.com/watch?v=...',
          tooMany: 'Maximum 25 URLs allowed',
          uploadLabel: 'Drag & drop a file here',
          uploadBrowse: 'Browse file',
          uploadHint: 'Accepted: .csv, .xlsx, .xls, .json (max 1 MB)',
          unsupportedFileType: 'Unsupported file type. Use .csv, .xlsx, .xls, or .json',
          defaultCategoriesLabel: 'Default categories (required; applied to all rows unless overridden)',
        ...
        errors: {
          ...
          UNSUPPORTED_HANDLE: 'Channel handles (@name, /c/, /user/) are not yet supported. Use the /channel/UC... URL from the channel page.',
          ...
          INTERNAL_ERROR: 'Internal error. Please try again or contact support.',
          DUPLICATE: 'Already in the registry.',
          DUPLICATE_REJECTED: 'Previously rejected. Re-approve from the approval queue if needed (not submittable in bulk).',
        },
      },
    },
    categories: {
    ...
    contentLibrary: {
      ...
      itemsMarkedPending: 'items sent back for review',
    ...
    audit: {
      ...
      pagination: {
        ...
        showingPartial: 'Showing {count}+ events (load more for additional)',
        loadMore: 'Load more'
      }
    },
    activity: {
    ...
    bulkImportExport: {
      ...
      import: {
        ...
        importStarted: 'Import started. Progress will be shown below.',
        importCompleted: 'Import completed: {imported} items imported, {failed} items failed',
        importFailed: 'Import failed. Please check the error details.',
        importAlreadyRunning: 'An import is already running. Please wait for it to complete.',
        serverBusy: 'Server is busy. Please retry after {retryAfter} seconds.',
        downloadFailedError: 'Failed to download failed items. Please try again.',
      ...
      phases: {
        ...
        PLAYLISTS: 'Processing playlists...',
  ...
  ar: {
    ...
    contentSearch: {
      ...
      searchPlaceholder: 'ابحث عن القنوات أو قوائم التشغيل أو الفيديوهات، أو الصق رابط YouTube...',
      search: 'بحث',
      searching: 'جارٍ البحث...',
      urlDetected: 'تم اكتشاف رابط {type} على YouTube — سيتم البحث مباشرة',
      urlNotFound: 'هذا المحتوى غير متاح أو خاص أو غير موجود.',
      retry: 'إعادة المحاولة',
      add: 'إضافة للموافقة',
      ...
      bulk: {
        tab: 'إضافة مجمّعة',
        tabLabel: 'إرسال مجمّع',
        loading: 'جارٍ المعالجة…',
        input: {
          pasteLabel: 'الصق روابط يوتيوب (رابط في كل سطر)',
          pasteHint: 'https://www.youtube.com/watch?v=...',
          tooMany: 'الحد الأقصى 25 رابطاً',
          uploadLabel: 'اسحب وأفلت ملفاً هنا',
          uploadBrowse: 'تصفح الملفات',
          uploadHint: 'الصيغ المقبولة: .csv، .xlsx، .xls، .json (بحد أقصى 1 ميغابايت)',
          unsupportedFileType: 'نوع الملف غير مدعوم. استخدم .csv أو .xlsx أو .xls أو .json',
          defaultCategoriesLabel: 'الفئات الافتراضية (مطلوبة؛ تُطبَّق على جميع الصفوف ما لم يُحدَّد غير ذلك)',
          categoriesLoading: 'جارٍ تحميل الفئات…',
          categoriesEmpty: 'لا توجد فئات متاحة',
        ...
        result: {
          addedHint: 'عنصر تمت إضافته إلى قائمة الانتظار للمراجعة.',
          errorsToggle: 'الأخطاء ({n})',
          submitAnother: 'إرسال دفعة أخرى',
          gotoPending: 'الذهاب إلى الموافقات المعلقة',
        },
        formatHelp: {
          ...
          excelTab: 'Excel',
          jsonTab: 'JSON',
          csvSpec: 'عمود واحد بعنوان URL، رابط واحد في كل صف، بحد أقصى 25 صفاً.',
          excelSpec: 'الورقة الأولى فقط. يجب أن تكون الخلية A1 تحمل "URL". الروابط من A2 فما بعد. بحد أقصى 25 صفاً.',
          jsonSpec: 'كائن من المستوى الأعلى: { "urls": [ ... ] }. بحد أقصى 25 إدخالاً.',
          downloadSample: 'تنزيل نموذج',
        },
        errors: {
          UNSUPPORTED_SHORTS: 'مقاطع YouTube Shorts غير مدعومة.',
          UNSUPPORTED_TYPE: 'نوع الرابط غير مدعوم.',
          UNSUPPORTED_HANDLE: 'معرفات القنوات (@name, /c/, /user/) غير مدعومة بعد. استخدم رابط /channel/UC... من صفحة القناة.',
          NOT_YOUTUBE_URL: 'ليس رابط YouTube صالحاً.',
          CONTENT_NOT_AVAILABLE: 'المحتوى غير متاح.',
          PRIVATE_CONTENT: 'محتوى خاص.',
          AGE_RESTRICTED: 'محتوى مقيد بالعمر.',
          GEO_RESTRICTED: 'محتوى محظور في منطقتك.',
          CHANNEL_TERMINATED: 'القناة موقوفة.',
          NEWPIPE_PARSING_ERROR: 'تعذّر تحليل الصفحة.',
          NETWORK_ERROR: 'خطأ في الشبكة أثناء جلب البيانات.',
          INTERNAL_ERROR: 'خطأ داخلي. حاول مرة أخرى أو تواصل مع الدعم.',
          DUPLICATE: 'موجود بالفعل في السجل.',
          DUPLICATE_REJECTED: 'سبق رفضه. أعد الموافقة من قائمة الموافقات إذا لزم الأمر (غير قابل للإرسال بالجملة).',
        },
      },
    },
    categories: {
    ...
    contentLibrary: {
      ...
      itemsMarkedPending: 'عنصرًا أُعيدت للمراجعة',
    ...
    audit: {
      ...
      pagination: {
        previous: 'السابق',
        next: 'التالي',
        showing: 'عرض {count} أحداث',
        showingPartial: 'عرض {count}+ أحداث (حمّل المزيد للحصول على المزيد)',
        loadMore: 'تحميل المزيد'
      }
    },
    activity: {
    ...
    bulkImportExport: {
      ...
      import: {
        ...
        importStarted: 'بدأ الاستيراد. سيتم عرض التقدم أدناه.',
        importCompleted: 'اكتمل الاستيراد: {imported} عنصر مستورد، {failed} عنصر فاشل',
        importFailed: 'فشل الاستيراد. يرجى التحقق من تفاصيل الخطأ.',
        importAlreadyRunning: 'هناك عملية استيراد قيد التشغيل بالفعل. يرجى الانتظار حتى اكتمالها.',
        serverBusy: 'الخادم مشغول. يرجى إعادة المحاولة بعد {retryAfter} ثانية.',
        downloadFailedError: 'فشل تنزيل العناصر الفاشلة. يرجى المحاولة مرة أخرى.',
        // Async import progress
        channels: 'القنوات',
        playlists: 'قوائم التشغيل',
        videos: 'الفيديوهات',
        ...
        failed: 'فاشل',
        totals: 'الإجماليات',
        totalImported: 'إجمالي المستورد',
        totalSkipped: 'إجمالي المتخطى',
        totalFailed: 'إجمالي الفاشل',
        downloadFailedItems: 'تنزيل العناصر الفاشلة',
        reasonCounts: 'أسباب الفشل',
        importProgress: 'تقدم الاستيراد'
      },
      phases: {
        STARTING: 'جارٍ البدء...',
        INITIALIZING: 'جارٍ التهيئة...',
        CHANNELS: 'جارٍ معالجة القنوات...',
        PLAYLISTS: 'جارٍ معالجة قوائم التشغيل...',
        VIDEOS: 'جارٍ معالجة الفيديوهات...',
        COMPLETE: 'مكتمل'
      },
      results: {
  ...
  nl: {
    ...
    contentSearch: {
      ...
      searchPlaceholder: 'Zoek naar kanalen, afspeellijsten of video\'s, of plak een YouTube-URL...',
      search: 'Zoeken',
      searching: 'Zoeken...',
      urlDetected: 'YouTube {type}-URL gedetecteerd — wordt direct opgezocht',
      urlNotFound: 'Deze inhoud is niet beschikbaar, privé of bestaat niet.',
      retry: 'Opnieuw proberen',
      ...
      searchTabLabel: 'Zoeken',
      bulk: {
        tab: 'Bulk toevoegen',
        tabLabel: 'Bulk indienen',
        loading: 'Bezig…',
        input: {
          pasteLabel: 'Plak YouTube-links (één per regel)',
          pasteHint: 'https://www.youtube.com/watch?v=...',
          tooMany: 'Maximaal 25 links toegestaan',
          uploadLabel: 'Sleep een bestand hiernaartoe',
          uploadBrowse: 'Bestand kiezen',
          uploadHint: 'Ondersteund: .csv, .xlsx, .xls, .json (max 1 MB)',
          unsupportedFileType: 'Bestandstype niet ondersteund. Gebruik .csv, .xlsx, .xls of .json',
          defaultCategoriesLabel: 'Standaardcategorieën (verplicht; toegepast op alle rijen tenzij overschreven)',
          categoriesLoading: 'Categorieën laden…',
          categoriesEmpty: 'Geen categorieën beschikbaar',
        ...
        preview: {
          ...
          colChannel: 'Kanaal',
          colStatus: 'Status',
          colCategories: 'Categorieën',
        },
        result: {
          addedHint: 'items toegevoegd aan de goedkeuringslijst.',
          errorsToggle: 'Fouten ({n})',
          submitAnother: 'Nog een batch indienen',
          gotoPending: 'Naar openstaande goedkeuringen',
        },
        formatHelp: {
          title: 'Bestandsformaathulp',
          csvTab: 'CSV',
          excelTab: 'Excel',
          jsonTab: 'JSON',
          csvSpec: 'Één kolom met koptekst URL, één URL per rij, max. 25 rijen.',
          excelSpec: 'Alleen eerste blad. Cel A1 moet "URL" zijn. URL\'s vanaf A2. Max. 25 rijen.',
          jsonSpec: 'Object op het hoogste niveau: { "urls": [ ... ] }. Max. 25 vermeldingen.',
          downloadSample: 'Voorbeeldbestand downloaden',
        },
        errors: {
          UNSUPPORTED_SHORTS: 'YouTube Shorts worden niet ondersteund.',
          UNSUPPORTED_TYPE: 'Dit type URL wordt niet ondersteund.',
          UNSUPPORTED_HANDLE: 'Kanaal-handles (@name, /c/, /user/) worden nog niet ondersteund. Gebruik de /channel/UC... URL van de kanaalpagina.',
          NOT_YOUTUBE_URL: 'Geen geldige YouTube URL.',
          CONTENT_NOT_AVAILABLE: 'Inhoud niet beschikbaar.',
          PRIVATE_CONTENT: 'Privé-inhoud.',
          AGE_RESTRICTED: 'Leeftijdsbeperkte inhoud.',
          GEO_RESTRICTED: 'Inhoud geblokkeerd in jouw regio.',
          CHANNEL_TERMINATED: 'Kanaal beëindigd.',
          NEWPIPE_PARSING_ERROR: 'Pagina kon niet worden geparseerd.',
          NETWORK_ERROR: 'Netwerkfout bij ophalen van metadata.',
          INTERNAL_ERROR: 'Interne fout. Probeer opnieuw of neem contact op met support.',
          DUPLICATE: 'Al aanwezig in het register.',
          DUPLICATE_REJECTED: 'Eerder afgewezen. Goedkeur opnieuw via de goedkeuringswachtrij indien nodig (niet bulkbaar).',
        },
      },
    },
    categories: {
    ...
    contentLibrary: {
      ...
      itemsMarkedPending: 'items teruggestuurd voor beoordeling',
    ...
    audit: {
      ...
      pagination: {
        previous: 'Vorige',
        next: 'Volgende',
        showing: '{count} gebeurtenissen getoond',
        showingPartial: '{count}+ gebeurtenissen getoond (laad meer voor extra)',
        loadMore: 'Meer laden'
      }
    },
    activity: {
    ...
    bulkImportExport: {
      ...
      import: {
        ...
        importStarted: 'Import gestart. Voortgang wordt hieronder weergegeven.',
        importCompleted: 'Import voltooid: {imported} items geïmporteerd, {failed} items mislukt',
        importFailed: 'Import mislukt. Controleer de foutdetails.',
        importAlreadyRunning: 'Er is al een import actief. Wacht tot deze is voltooid.',
        serverBusy: 'Server is bezet. Probeer het opnieuw na {retryAfter} seconden.',
        downloadFailedError: 'Mislukte items downloaden mislukt. Probeer het opnieuw.',
        // Async import progress
        channels: 'Kanalen',
        playlists: 'Afspeellijsten',
        videos: "Video's",
        ...
        failed: 'Mislukt',
        totals: 'Totalen',
        totalImported: 'Totaal geïmporteerd',
        totalSkipped: 'Totaal overgeslagen',
        totalFailed: 'Totaal mislukt',
        downloadFailedItems: 'Download mislukte items',
        reasonCounts: 'Faalredenen',
        importProgress: 'Importvoortgang'
      },
      phases: {
        STARTING: 'Starten...',
        INITIALIZING: 'Initialiseren...',
        CHANNELS: 'Kanalen verwerken...',
        PLAYLISTS: 'Afspeellijsten verwerken...',
        VIDEOS: "Video's verwerken...",
        COMPLETE: 'Voltooid'
      },
      results: {
