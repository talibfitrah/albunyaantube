...
class ShortsPlayerFragment : Fragment(R.layout.fragment_shorts_player) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        childFragmentManager.setFragmentResultListener(
            ...
            viewModel.player.trackSelectionParameters = if (code == null) {
                viewModel.player.trackSelectionParameters.buildUpon()
    ...
    private fun openSubtitlePicker(idx: Int) {
        ...
        val params = viewModel.player.trackSelectionParameters
        val currentCode = if (params.disabledTrackTypes.contains(C.TRACK_TYPE_TEXT)) null
            else params.preferredTextLanguages.firstOrNull()
