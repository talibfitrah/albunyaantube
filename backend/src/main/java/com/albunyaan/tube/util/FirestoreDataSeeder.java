...
public class FirestoreDataSeeder implements CommandLineRunner {
    ...
    private static final List<CategorySeed> CATEGORY_SEEDS = List.of(
            new CategorySeed("quran", "Qur'an Recitation", null, 1, placeholder("Quran"),
                    Map.of("en", "Qur'an Recitation", "ar", "تلاوة القرآن")),
            new CategorySeed("quran-beginner", "Beginner Qur'an", "quran", 2, placeholder("Beginner+Quran"),
                    Map.of("en", "Beginner Qur'an")),
            new CategorySeed("tajweed", "Tajweed Rules", "quran", 3, placeholder("Tajweed"),
                    Map.of("en", "Tajweed Rules")),
            new CategorySeed("memorization", "Hifdh & Memorization", "quran", 4, placeholder("Hifdh"),
                    Map.of("en", "Memorization")),
            new CategorySeed("hadith", "Hadith Collections", null, 5, placeholder("Hadith"),
                    Map.of("en", "Hadith Collections")),
            new CategorySeed("hadith-40", "Forty Hadith", "hadith", 6, placeholder("40+Hadith"),
                    Map.of("en", "Forty Hadith")),
            new CategorySeed("seerah", "Seerah & Prophetic Biography", null, 7, placeholder("Seerah"),
                    Map.of("en", "Seerah")),
            new CategorySeed("tafsir", "Tafsir & Explanation", null, 8, placeholder("Tafsir"),
                    Map.of("en", "Tafsir")),
            new CategorySeed("tafsir-bites", "Tafsir Bites", "tafsir", 9, placeholder("Tafsir+Bites"),
                    Map.of("en", "Tafsir Bites")),
            new CategorySeed("aqeedah", "Aqeedah & Creed", null, 10, placeholder("Aqeedah"),
                    Map.of("en", "Aqeedah")),
            new CategorySeed("fiqh", "Fiqh & Practical Rulings", null, 11, placeholder("Fiqh"),
                    Map.of("en", "Fiqh")),
            new CategorySeed("kids", "Kids Corner", null, 12, placeholder("Kids"),
                    Map.of("en", "Kids Corner")),
            new CategorySeed("youth", "Youth Programs", null, 13, placeholder("Youth"),
                    Map.of("en", "Youth")),
            new CategorySeed("arabic", "Arabic Language", null, 14, placeholder("Arabic"),
                    Map.of("en", "Arabic")),
            new CategorySeed("nasheed", "Nasheeds (Voice Only)", null, 15, placeholder("Nasheed"),
                    Map.of("en", "Nasheeds")),
            new CategorySeed("lifestyle", "Everyday Muslim Life", null, 16, placeholder("Lifestyle"),
                    Map.of("en", "Lifestyle")),
            new CategorySeed("history", "Islamic History", null, 17, placeholder("History"),
                    Map.of("en", "History")),
            new CategorySeed("revert-support", "New Muslim Support", null, 18, placeholder("Revert+Support"),
                    Map.of("en", "New Muslim Support")),
            new CategorySeed("wellness", "Wellness & Mindfulness", null, 19, placeholder("Wellness"),
                    Map.of("en", "Wellness"))
    );
