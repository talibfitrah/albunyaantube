...
public class FirestoreDataSeeder implements CommandLineRunner {
    ...
    private static final List<CategorySeed> CATEGORY_SEEDS = List.of(
            ...
            new CategorySeed("quran-beginner", "Beginner Qur'an", "quran", 2, "🌱",
                    Map.of("en", "Beginner Qur'an")),
            new CategorySeed("tajweed", "Tajweed Rules", "quran", 3, "🎵",
                    Map.of("en", "Tajweed Rules")),
            new CategorySeed("memorization", "Hifdh & Memorization", "quran", 4, "🧠",
                    Map.of("en", "Memorization")),
            new CategorySeed("hadith", "Hadith Collections", null, 5, "📿",
                    Map.of("en", "Hadith Collections")),
            new CategorySeed("hadith-40", "Forty Hadith", "hadith", 6, "4️⃣0️⃣",
                    Map.of("en", "Forty Hadith")),
            new CategorySeed("seerah", "Seerah & Prophetic Biography", null, 7, "🕌",
                    Map.of("en", "Seerah")),
            new CategorySeed("tafsir", "Tafsir & Explanation", null, 8, "💡",
                    Map.of("en", "Tafsir")),
            new CategorySeed("tafsir-bites", "Tafsir Bites", "tafsir", 9, "✨",
