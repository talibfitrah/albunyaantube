...
/** Error codes returned per-row by the bulk preview endpoint. */
public enum PreviewErrorCode {
    UNSUPPORTED_SHORTS,
    UNSUPPORTED_TYPE,
    /**
     * /@handle, /c/customname, /user/legacyname URLs are not
    ...
    NETWORK_ERROR,
    /**
     * Backend-side failure unrelated to NewPipe parsing
