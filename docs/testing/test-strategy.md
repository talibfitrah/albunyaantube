...
- **Android Downloads Queue** (Phase 9 prep, 2025-10-07): WorkManager-backed `DownloadWorker` scaffolding landed; upcoming unit/instrumentation coverage will exercise pause/resume/cancel paths, storage pressure, and notification/analytics wiring once actual file writes land.
