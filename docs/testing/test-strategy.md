...
- **Android Downloads Queue** (Phase 9, 2025-10-07): WorkManager-backed `DownloadWorker` now resolves NewPipe streams, enforces a 500 MB quota, and notifies analytics; forthcoming instrumentation will simulate pause/resume/cancel, storage pressure, and TalkBack messaging across notifications + download screens.
