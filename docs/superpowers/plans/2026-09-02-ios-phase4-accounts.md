...
- **No music-video ids** in tests, fixtures, docs or live checks (owner directive): never `dQw4w9WgXcQ`, playlist `PL6SWGxz3wzpSrxgiBj2PCuEf-MenhYTCc`, channel `UCmMcOjsVehVlEOteyrhjI2Q`. Use approved-catalog lecture ids (`xc7keR2piUM`).
