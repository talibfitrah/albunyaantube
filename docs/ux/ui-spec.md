...
- Android scaffold (2025-10-06): ExoPlayer screen now includes audio-only switch, status text, Up Next list with manual selection, policy exclusion notice, and analytics debug banner while awaiting backend stream metadata and control chrome.
